...
> **🚨 UNIFIED OVERRIDE (2026-07-22, Bố duyệt):** MỌI output loại **analysis / report / kết-luận-từ-data** PHẢI spawn independent critic qua `reviewer-node` — **KHÔNG discretionary, kể cả zone 🟢**. Áp dụng cho warren / stock / personal.
...
- **Action:** spawn `reviewer-node` (goal + context = output + domain checklist).
- **verify-parser-output PHẢI chạy TRƯỚC** nếu artifact có số.
