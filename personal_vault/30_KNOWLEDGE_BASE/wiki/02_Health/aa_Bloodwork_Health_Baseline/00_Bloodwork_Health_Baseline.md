...
- Height: 171cm
- Weight: 63kg (current) | BMI ~21.5
- Resting HR: _(TODO — đo và điền)_
- BP: _(TODO — đo tại DIAG lần tới)_
...
## Daily habits
- Intermittent fasting: 16:8 — eating window 12:00–20:00
...
- **🔴 Tiểu đường top 25%** (IGF2BP2) — IF đang bù tốt, giữ nguyên
- **🔴 Chuyển hóa béo kém** (APOA5/PPARG) — LDL tăng khi ăn béo bão hòa → root cause LDL cao
- **🟡 Thải độc kém** (CYP1A1/CYP3A) — zero khói thuốc
- **✅ Caffeine nhanh** (CYP1A2) — <400mg/ngày OK
- **✅ Tim mạch gen tốt** — nhưng phenotype (LDL/ApoB) đang xấu hơn gen predict
- **✅ Gan gen trung tính** — confirmed bằng LFT 11/06/2026

## Targets / goals (cập nhật 2026-06-11)
- **LDL mục tiêu:** <3.35 mmol/L (lặp lại 09/2026)
- **ApoB mục tiêu:** <100 mg/dL (lặp lại 09/2026)
- **HbA1c mục tiêu:** <5.7% — giữ IF

---
_Synced from CONTEXT.md §4 — 2026-06-11
