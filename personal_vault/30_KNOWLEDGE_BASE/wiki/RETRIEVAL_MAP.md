---
description: "Topic → canonical source map for Personal OS. ORION reads this FIRST before any data query."
last_generated: 2026-06-10
generated_from: 00_WIKI_INDEX.md
---

# RETRIEVAL_MAP — Personal OS

> **Index first:** Moi domain co index.md trong canonical_path. Doc index truoc de biet file nao can — tiet kiem token, tranh doc thua.
> **Rolling data:** Ngoai wiki, du lieu hang ngay/tuan nam o 10_PULSE/. Doc 00_PULSE_INDEX.md truoc khi fetch pulse files.

| domain | topic / aliases | canonical_path | notes |
|--------|-----------------|----------------|-------|
...
| _growth | knowledge capture, parenting, communication, growth, sach | _growth/ | 00_INDEX.md là entry point; knowledge files theo template |
